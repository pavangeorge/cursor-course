...
export default function Sidebar({ isCollapsed, onToggle }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div 
        className={`fixed md:relative transition-all duration-300 z-50
      ...
      >
        ...
        <button
          onClick={onToggle}
          className="absolute -right-3 top-6 w-6 h-6 bg-white border border-gray-200 rounded-full shadow-sm flex items-center justify-center hover:bg-gray-50 hidden md:flex"
        >
          {isCollapsed ? (
